...
This provides realistic demo data when the app is first run.

🧱 Database Diagram

Add your database diagram screenshot here:
...
⚠️ Never commit sensitive data. Use environment variables or appsettings.Development.json.
